...
class Calculator extends Component {
    ...
    createInterest = () => {
        ...
        for (let i = 0; i < 20; i++) {
            Interest.push(<option value={i+1}>{i+1}%</option>)
        }
        return Interest
      }
      createTerm = () => {
        ...
        for (let i = 1; i < 15; i++) {
            Term.push(<option value={i*3}>{i*3} Months</option>)
        }
        return Term
      }
    ...
    handleOnChange = (value) => {
        ...
        console.log('xxxxxx xxxxx state', this.state);
    ...
    handleChange=(evt)=> {
      ...
      CalculatorFn=(val)=>{
        console.log('xxxxxx xxxxx ttt', val);
        ...
        console.log('eeeeeeeee', FinalEmi);
        ...
        return (
          ...
          onChange={this.handleChange}>
                      ...
                      <input name="term" type="hidden" id="term" value='quarterly' readOnly="readOnly" />
                            <div className="btn-group btn-group-justified">
                            <select className="form-control" name="loan_interest"
                      ...
                      <div className="price-form">
                        ...
                        <div className="form-group">
                            <div className="row">
                              ...
                              <div className="col-sm-6">
                                  <input className="price lead" name="totalprice" type="text" value={this.state.volume} disabled="disabled"  />
                              </div>
                          </div>
                          </div>
                          <div className="form-group">
                            <div className="row">
                              ...
                              <div className="col-sm-6">
                                  ...
                                  <input className="price lead"  type="text" value={this.state.total_interest_pay_text} disabled="disabled" 
                          ...
                          <div className="form-group">
                            <div className="row">
                              <div className="col-sm-6">
                                <label htmlFor="amount_amirol" className="control-label">Fee ($): </label>
                              </div>
                              <div className="col-sm-6">
                                 
                                  <input className="price lead" type="text" value={this.state.fee} disabled="disabled" 
                                   />
                              </div>
                          </div>
                          </div>
                          <div className="form-group">
                            <div className="row">
                              <div className="col-sm-6">
                                <label htmlFor="amount_amirol" className="control-label">Service ($): </label>
                              </div>
                              <div className="col-sm-6">
                                 
                                  <input className="price lead" type="text" value={this.state.servise} disabled="disabled" 
                                   />
                              </div>
                          </div>
                          </div>
                          <div className="form-group">
                            <div className="row">
                              ...
                              <div className="col-sm-6">
                                  ...
                                  <input className="price lead" type="text" value={this.state.total_amt} disabled="disabled" 
                                   />
                              </div>
                          </div>
                          </div>
                        ...
                        <div className="card">
                        <span className="pull-left"><h3>Payment</h3></span>
                        <span className="pull-right"><h3>${this.state.FinalEmi}/monthly</h3></span>
